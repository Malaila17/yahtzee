...
function calcTotals(deel1, deel2) {
  ...
  document.getElementsByClassName("ptVoorBonus spel1")[0].innerHTML =
    sumDeel1GeenBonus;
  document.getElementsByClassName("bonus spel1")[0].innerHTML = bonus;
  document.getElementsByClassName("ptDeel1 spel1")[0].innerHTML =
    sumDeel1GeenBonus + bonus;
  document.getElementsByClassName("ptDeel1 spel1")[1].innerHTML =
    sumDeel1GeenBonus + bonus;
  document.getElementsByClassName("ptDeel2 spel1")[0].innerHTML = sumDeel2;
  document.getElementsByClassName("ptTotaal spel1")[0].innerHTML =
    sumDeel1GeenBonus + bonus + sumDeel2;
}
